        ...
        <div class="container">
            ...
            <section class="mb-7"> 
                        ...
                        <div class="col-md-12 mb-6">
                            <div class="alert alert-primary alert-bg alert-button alert-block">
                                ...
                                <p style="max-width: 10000000rem;">
                                    Siparişinizin başarı ile tamamlanması için aşağıda belirtilen banka hesaplarımıza sipariş tutarınızı ödemeniz gerekmektedir. Ödeme yaptıktan sonra müşteri temsilcilerimize ulaşarak ödeme yapıldığının bilgisini vermeniz gerekmektedir.   
                                </p>
                ...
                <div class="tab-pane mb-4" id="account-orders" style="background-color: #eee; padding-top: .8rem; padding: 15px;">
                    ...
                    <table class="shop-table account-orders-table mb-6">
                        <thead>
                            <tr>
                                ...
                                <th class="order-actions">Bildirim</th>
                            </tr>
                        </thead>
                        <tbody>
                          <?php 
                          ...
                          foreach ($cek as $ak) { ?>
                            <tr style="background-color: #fff">
                                ...
                                <td class="order-action">
                                    <a href="tel:<?=$ayar['phone'];?>"
                                        class="btn btn-outline btn-default btn-block btn-sm btn-rounded">BİLDİRİM</a>
                                    </td>
                                </tr>
                            <?php } ?>
                    ...
                    <a href="<?=$ayar['web_adress'];?>" class="btn btn-dark btn-rounded btn-icon-right">Anasayfa<i class="w-icon-long-arrow-right"></i></a>
                </div>
